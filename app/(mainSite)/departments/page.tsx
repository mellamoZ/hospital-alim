    ...
    <div className="my-10 flex items-center justify-center">
      <div className="flex max-w-screen-xl flex-col justify-center gap-5 px-10">
        {departments.map((department) => (
          <Dialog key={department.department_id}>
            <DialogTrigger>
              <Card className="px-10 py-6 delay-75 duration-150 hover:bg-gray-100">
                <CardContent className="p-4">
                  ...
                  <CardDescription className="mt-4 text-sm text-gray-800 dark:text-gray-400">
                    {`${department.description} Lorem ipsum dolor sit amet consectetur adipisicing elit.
            ...
            <DialogContent className="max-w-screen-lg">
              <DialogHeader>
                <DialogTitle>{department.department_name}</DialogTitle>
              </DialogHeader>
              <Image
                src={default_image}
